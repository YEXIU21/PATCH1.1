  ...
  const promos = [
    {
      id: 1,
      title: 'Welcome Bonus',
      description: 'Get 100% up to PHP 500 on your first deposit!',
    ...
    },
    {
      ...
      description: 'Get 50 free spins on our featured slot games every Tuesday when you deposit PHP 20 or more.',
      image: 'https://via.placeholder.com/800x400',
    ...
    },
    {
      ...
      description: 'Get PHP 50 for each friend you refer who makes a deposit of PHP 20 or more.',
      image: 'https://via.placeholder.com/800x400',
      expiryDate: null,
      category: 'general'
    },
    {
      ...
      description: 'Receive 10% cashback up to PHP 200 on live dealer games every weekend.',
      image: 'https://via.placeholder.com/800x400',
      expiryDate: '2023-12-31',
      category: 'casino'
    }
